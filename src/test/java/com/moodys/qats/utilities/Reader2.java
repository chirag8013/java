...
public class Reader2{
	...
	XLSX_READER2 reader = new XLSX_READER2("D:\\Users/VermaC/Documents/ui/Analyst_Loc_Region_Country.xlsx");
	...
	public List<String> getcountryid() {
		...
		for (int i = 2; i <= rowcount; i++) {
			...
			String country = reader.getCellData(SHEETNAME, 6, i);
	...
	public List<String> getregionid() {
		...
		for (int i = 2; i <= rowcount; i++) {
			...
			String region = reader.getCellData(SHEETNAME, 7, i);
	...
	public List<String> getanalystlocation() {
		...
		for (int i = 2; i <= rowcount; i++) {
			...
			String analyst = reader.getCellData(SHEETNAME, 0, i);
