...
public class ORPStepDefinition {
	...
	@Given("^web service returns rating actions for RatingRelInfoORP between dates (\\d+) and (\\d+) for Openshift$")
	public void web_service_returns_rating_actions_for_RatingRelInfoORP_between_dates_and_for_Openshift(int startdate, int enddate) throws Throwable {
		prop = new Properties();
	...
	@Given("^web service returns rating actions for RatingRelInfoORP between dates (\\d+) and (\\d+) for Docker$")
	public void web_service_returns_rating_actions_for_RatingRelInfoORP_between_dates_and_for_Docker(int startdate, int enddate) throws Throwable {
		prop = new Properties();
	...
	@When("^a user requests for rating release data for ORP by Dates for Openshift and fetch \"([^\"]*)\"$")
	public void a_user_requests_for_rating_release_data_for_ORP_by_Dates_for_Openshift_and_fetch(String field) throws Throwable {
	...
	@When("^a user requests for rating release data for ORP by Dates for Docker and fetch \"([^\"]*)\"$")
	public void a_user_requests_for_rating_release_data_for_ORP_by_Dates_for_Docker_and_fetch(String field) throws Throwable {
	...
	public void validate_the_ORP_response_from_Openshift_and_docker() throws Throwable {
